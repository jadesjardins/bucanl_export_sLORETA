...
function writesLORdatIC(EEG,outfname,outfpath,varargin)
...
try g.icinds; catch, g.icinds = 1:size(EEG.icawinv,2); end;

for i=1:length(g.icinds);
    g.data(:,i)=EEG.icawinv(:,g.icinds(i));
    %figure;topoplot(g.data(:,i),EEG.chanlocs)
end
